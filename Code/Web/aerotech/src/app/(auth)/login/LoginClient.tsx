        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-3 py-2 border border-brand-200 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500"
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full px-3 py-2 border border-brand-200 rounded-md
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 rounded-md font-medium text-white bg-gradient-to-r
